(function () {
    ...
    (function (ui) {
        ...
        CenterGameBoxUI.uiView = { "type": "View", "props": { "width": 443, "height": 209 }, "compId": 2, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 443, "skin": "oppo/4.png", "sizeGrid": "84,121,71,162", "height": 209 }, "compId": 22 }, { "type": "Box", "props": { "y": 6, "x": 9, "width": 426, "var": "bigBox", "height": 197 }, "compId": 27 }], "loadList": ["oppo/4.png"], "loadList3D": [] };
        ...
        mainGameBoxUI.uiView = { "type": "View", "props": { "width": 750, "height": 1334 }, "compId": 2, "child": [{ "type": "Box", "props": { "y": 0, "x": 0, "width": 750, "var": "hitBox", "height": 1334 }, "compId": 38 }, { "type": "Image", "props": { "y": 300, "width": 200, "var": "bg", "skin": "oppo/6.png", "sizeGrid": "73,85,87,95", "height": 785, "cacheAs": "bitmap" }, "compId": 5 }, { "type": "Image", "props": { "y": 330, "x": 195, "width": 38, "var": "hideBtn", "skin": "oppo/2.png", "mouseEnabled": false, "height": 116 }, "compId": 30 }], "loadList": ["oppo/6.png", "oppo/2.png"], "loadList3D": [] };
        ui.mainGameBoxUI = mainGameBoxUI;
        REG("ui.mainGameBoxUI", mainGameBoxUI);
        class OppoIcon100UI extends Laya.View {
            constructor() { super(); }
            createChildren() {
                super.createChildren();
        ...
        OppoIcon100UI.uiView = { "type": "View", "props": { "y": 65, "x": 50, "width": 100, "height": 130, "anchorY": 0.5, "anchorX": 0.5 }, "compId": 2, "child": [{ "type": "Image", "props": { "width": 100, "var": "iconImg", "height": 100 }, "compId": 3 }, { "type": "hot", "props": { "y": -3, "x": 66, "runtime": "ui.scene.hotUI" }, "compId": 4 }, { "type": "Label", "props": { "y": 110, "width": 100, "var": "nameTxt", "text": "脑洞大爆炸", "height": 20, "fontSize": 20, "color": "#ffffff", "align": "center" }, "compId": 5 }], "loadList": [], "loadList3D": [] };
        ui.OppoIcon100UI = OppoIcon100UI;
        REG("ui.OppoIcon100UI", OppoIcon100UI);
        class OppoIcon120UI extends Laya.View {
            constructor() { super(); }
            createChildren() {
                super.createChildren();
        ...
        OppoIcon120UI.uiView = { "type": "View", "props": { "y": 77, "x": 60, "width": 120, "height": 154, "anchorY": 0.5, "anchorX": 0.5 }, "compId": 2, "child": [{ "type": "Image", "props": { "width": 120, "var": "iconImg", "height": 120 }, "compId": 3 }, { "type": "hot", "props": { "y": 0, "x": 86, "runtime": "ui.scene.hotUI" }, "compId": 4 }, { "type": "Label", "props": { "y": 130, "width": 120, "var": "nameTxt", "text": "脑洞大爆炸", "height": 24, "fontSize": 24, "color": "#ffffff", "align": "center" }, "compId": 5 }], "loadList": [], "loadList3D": [] };
        ui.OppoIcon120UI = OppoIcon120UI;
        REG("ui.OppoIcon120UI", OppoIcon120UI);
        ...
        rightGameBoxUI.uiView = { "type": "View", "props": { "width": 100, "height": 100 }, "compId": 2, "child": [{ "type": "Box", "props": { "y": 0, "x": 50, "width": 100, "var": "bigBox", "height": 100, "anchorX": 0.5 }, "compId": 12, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 100, "var": "iconImg", "height": 100 }, "compId": 3 }, { "type": "Image", "props": { "y": 78, "x": 0, "skin": "oppo/3.png" }, "compId": 11 }] }], "loadList": ["oppo/3.png"], "loadList3D": [] };
    ...
    class OppoIcon120 extends ui.OppoIcon120UI {
        constructor(info) {
            super();
            this._info = info;
        ...
        onClick() {
            let packName = this._info.packName;
    ...
    class MainGameBox extends ui.mainGameBoxUI {
        constructor() {
            ...
            let arr = MyConfig.oppoGames;
            for (let i = 0; i < 4; i++) {
                let icon120 = new OppoIcon120(arr[i]);
    ...
    class MainSceneMediator extends Mediator {
        ...
        init() {
            ...
            this.mainScene.redBtn.visible = MyConfig.oppoSwitch == 1;
            if (MyConfig.oppoSwitch == 1) {
                this.mainScene.redBtn.y = 340;
                this.mainScene.rightOppoBox.y = 380;
                if (!this.mainGameBox) {
    ...
    class OppoIcon100 extends ui.OppoIcon100UI {
        constructor(info) {
            super();
            this._info = info;
            this.iconImg.skin = "oppo/" + this._info.url;
    ...
    class CenterGameBox extends ui.CenterGameBoxUI {
        ...
        onDis() {
            ...
            let arr = MyConfig.oppoGames;
            for (let i = 0; i < 4; i++) {
                let icon100 = new OppoIcon100(arr[i]);
        ...
        onOnce() {
            ...
            box.x = 50 + (MyConfig.oppoGames.length - 1) * 163;
            box.scale(1, 1);
